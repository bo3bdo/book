...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-9" id="viewer-container">
            ...
            <div class="pdf-viewer-container" id="main-viewer">                <!-- عارض iframe -->
                <div id="iframe-viewer" style="width: 100%; height: 100%; position: relative;">
                    <iframe 
                        id="pdf-viewer"
                        class="pdf-viewer" 
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.ctrlKey && e.shiftKey && e.key === 'C') {
        e.preventDefault();
        e.stopPropagation();
        showMessage('فحص العنصر غير متاح', 'error');
        return false;
    }
    ...
    if (e.ctrlKey && e.key === 'w') {
        e.preventDefault();
        e.stopPropagation();
        showMessage('إغلاق التبويب غير مسموح أثناء القراءة', 'warning');
        return false;
    }
    ...
    if (e.ctrlKey && e.shiftKey && e.key === 'J') {
        e.preventDefault();
        e.stopPropagation();
        showMessage('وحدة التحكم غير متاحة', 'error');
        return false;
    }
}, true);

// منع النقر بالزر الأيمن بشكل كامل
...
// منع النقر بالزر الأيمن على iframe أيضاً
...
window.addEventListener('load', function() {
    ...
    const iframe = document.getElementById('pdf-viewer');
    const protectionOverlay = document.querySelector('.protection-overlay');
    ...
    iframe.addEventListener('load', function() {
        ...
        try {
            ...
            if (iframe.contentDocument || iframe.contentWindow) {
                ...
                // منع الطباعة داخل iframe
                iframe.contentWindow.print = function() {
                    showMessage('الطباعة غير مسموحة', 'error');
                    return false;
                };
                
                // منع حفظ الصفحة داخل iframe
                iframe.contentDocument.addEventListener('keydown', function(e) {
                    if (e.ctrlKey && (e.key === 's' || e.key === 'p')) {
                        e.preventDefault();
                        e.stopPropagation();
                        parent.showMessage('العملية غير مسموحة', 'error');
                        return false;
                    }
                }, true);
            }
    ...
    // مراقبة محاولات النقر الأيمن
    let rightClickAttempts = 0;
    document.addEventListener('contextmenu', function(e) {
        rightClickAttempts++;
        if (rightClickAttempts > 3) {
            showMessage('تم رصد محاولات متكررة للنقر الأيمن. يرجى الالتزام بقواعد الاستخدام.', 'error');
        }
    });
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'F12' || (e.ctrlKey && e.shiftKey && e.key === 'I')) {
            ...
            if (devToolsAttempts > 2) {
                showMessage('تم رصد محاولات متكررة لفتح أدوات المطور. هذا قد يؤثر على تجربة القراءة.', 'warning');
            }
        }
    });
    ...
    if (protectionOverlay) {
        protectionOverlay.addEventListener('dragstart', function(e) {
            e.preventDefault();
            showMessage('السحب والإفلات غير مسموح', 'warning');
            return false;
        });
